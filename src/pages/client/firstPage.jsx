...
export default function FirstPage() {
  ...
  function growingStats() {
    const valueDisplay = document.querySelectorAll(".stats .display");
    ...
    valueDisplay.forEach((value) => {
      ...
      const interval = setInterval(() => {
        ...
        if (currentValue >= targetValue) {
          ...
          if (targetValue === 24) {
            value.textContent = targetValue + "/7";
          } else {
            value.textContent = targetValue + "+";
          }
        } else {
          if (targetValue === 24) {
            value.textContent = Math.round(currentValue) + "/7";
          } else {
  ...
  function growingExperience() {
    const valueDisplay = document.querySelectorAll(".experience .display");
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (
        !experienceAnimatedRef.current &&
        experienceTop !== undefined &&
        experienceTop < windowHeight - 100
      ) {
        growingExperience();
        experienceAnimatedRef.current = true;
      }
    };
        ...
        <div className="firstPageContainer">
          ...
          <section className="hero">
            <div className="hero-content">
              ...
              <p className="description">
                ...
                Microchipping and much more. Experienced doctors will always
                care for your precious furry friends.
              </p>

              <div className="hero-buttons">
                <Link className="btn-cta" to="/appointment">
                  Book Appointment
                </Link>
          ...
          <section className="services" id="services">
            <div
              ...
              onClick={() => gotoAppointment("boarding")}
            >
            ...
            <div
              ...
              onClick={() => gotoAppointment("walking")}
            >
            ...
            <div
              ...
              onClick={() => gotoAppointment("grooming")}
            >
            ...
            <div
              ...
              onClick={() => gotoAppointment("veterinary")}
            >
          ...
          <section className="notice">
            ...
            <p>
              Our hospital operates until <b>10:00 PM</b>. However, to ensure
              quality care for ongoing treatments and follow-ups, we stop
              admitting new cases at <b>9:00 PM</b>.
            </p>

            <p>
              Please bring your pets for consultations before 9:00 PM. Thank
          ...
          <section className="diagnostics">
            <div className="diag-text">
              ...
              <p>
                Our hospital is equipped with modern diagnostic facilities such
                as Digital Radiography, Ultrasound scanning, Echography, Blood
                Pressure monitoring, Ultrasonic dental scaling and many more
          ...
          <section className="laboratory">
            ...
            <p>
              ...
              diagnostic facilities and internal and external quality control
              systems to assure accurate test results.
            </p>

            <p>
              Experienced and qualified laboratory technicians operate our
              laboratory under the guidance of veterinary doctors.
            </p>
          ...
          <section className="experience" ref={experienceRef}>
            <div>
              <h1 className="display" data-value="23">
                23+
              </h1>
            ...
            <div>
              <h1 className="display" data-value="40000">
                40000+
              </h1>
            ...
            <div>
              <h1 className="display" data-value="365">
                365
              </h1>
              <p>Days Available</p>
            </div>
          ...
          <section className="mobile-service">
            ...
            <p>
              Our patients receive personal attentive care from annual
              vaccination to complicated medical conditions.
            </p>
          ...
          <section className="special-services">
            ...
            <p>Our experienced doctors provide veterinary services to:</p>
          ...
          <section className="stats" ref={statsRef}>
            <div className="stats-content">
              <div>
                <h2 className="display" data-value="1000">
                  1000+
                </h2>
              ...
              <div>
                <h2 className="display" data-value="500">
                  500+
                </h2>
              ...
              <div>
                <h2 className="display" data-value="24">
                  24/7
                </h2>
                <p>Availability</p>
              </div>
